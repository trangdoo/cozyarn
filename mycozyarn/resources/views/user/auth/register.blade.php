        ...
        <div class="auth-form">
            ...
            <div class="auth-social">
                ...
                <div class="auth-social__btns">
                    <a href="#" class="auth-social__btn" aria-label="Sign up with Google" aria-disabled="true" title="Đang phát triển — vui lòng dùng email" onclick="event.preventDefault();alert('Đăng ký Google đang được phát triển. Vui lòng dùng email.');">
                    ...
                    <a href="#" class="auth-social__btn" aria-label="Sign up with Facebook" aria-disabled="true" title="Đang phát triển — vui lòng dùng email" onclick="event.preventDefault();alert('Đăng ký Facebook đang được phát triển. Vui lòng dùng email.');">
