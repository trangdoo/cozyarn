...
|----:|---|---|---|---|---:|
| 1 | _Họ Tên 1 (Trưởng nhóm)_ | _MSSV_ | Backend + DevOps | Auth, Checkout, SePay webhook, Docker, Deploy | 100% |
| 2 | _Họ Tên 2_ | _MSSV_ | Backend | Admin CRUD (product/category/blog/order), Chat | 100% |
| 3 | _Họ Tên 3_ | _MSSV_ | Frontend | Layout, Tailwind, các trang public + user | 100% |
| 4 | _Họ Tên 4_ | _MSSV_ | Frontend + QA | Plugin/Skin UI, kiểm thử, viết tài liệu | 100% |

**Giảng viên hướng dẫn:** _Thầy/Cô …_
...
|---|---|---|
| Admin | `admin@cozyarn.local` | `password` |
| User mẫu | `user@cozyarn.local` | `password` |
